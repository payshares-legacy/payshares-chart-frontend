...
function handleLedger(err, obj) {
  ...
  $("#totalpaysharess").text(commas(parseInt(currentLedger.total_coins, 10)/1000000));
}
...
function eraseGraph() {
  ...
  $("#loading").html('<img class="loader" src="assets/images/paysharesThrobber.png" style="vertical-align: middle;" /> Loading...');
}
...
function updateTransactions(address, appending) {
  ...
  if (nodes[nodeMap[address]].transactions) {
    ...
    if (!nodes[nodeMap[address]].transactionsFinished) { //Are there more?
      $('#transactionTable').append('<tr id="transactionThrobber"><td colspan=3 style="text-align:center; padding:10px"><img class="loader" src="assets/images/paysharesThrobber.png" width=30 height=30 /></td></tr>');
